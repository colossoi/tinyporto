...
pub struct Renderer {
    ...
    materials: Materials,
    water_spectrum: crate::water_spectrum::Spectrum,
...
impl Renderer {
    pub fn new(gfx: Gfx, cam: &Camera, mods: u32, time: f32) -> Result<Self> {
        ...
        let mut renderer = Self {
            ...
            water_spectrum: crate::water_spectrum::Spectrum::new(&gfx.device, &gfx.queue),
    ...
    fn encode_frame(
        ...
        let output = generated::encode_tinyporto_frame(
            ...
            &self.terrain,
            &self.world.occ,
            &self.water_spectrum.h0,
            &self.water_spectrum.waves,
            &self.world.gi,
